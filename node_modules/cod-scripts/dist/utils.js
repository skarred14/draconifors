...
function resolveBin(modName, {
  ...
  try {
    ...
    const {
      bin
    } = require(modPkgPath); // eslint-disable-line
...
function getConcurrentlyArgs(scripts, {
  ...
  const colors = ['bgBlue', 'bgGreen', 'bgMagenta', 'bgCyan', 'bgWhite', 'bgRed', 'bgBlack', 'bgYellow']; // eslint-disable-next-line no-param-reassign
